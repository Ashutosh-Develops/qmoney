...
class TiingoServiceTest {
  ...
  @Test
  void getStockQuotesFromTiingo() throws JsonProcessingException{
    
  //  ObjectMapper objectMapper=new ObjectMapper();
   // Candle[] candleResp=objectMapper.readValue(sampleTiingoResponse,TiingoCandle[].class);
    

    RestTemplate restTemplate=new RestTemplate();
    TiingoService tiingoService=new TiingoService(restTemplate);
    LocalDate startDate=LocalDate.parse("2019-01-01");
    LocalDate endDate=LocalDate.parse("2019-01-04");
    String symbol="GOOGL";
    List<Candle> candles=tiingoService.getStockQuote(symbol,startDate,endDate);
